/* Temporary topics being rendered in search (once redux is
 ready these should be global and dynamic) */
const Topics = [
  'Objects',
  'Arrays',
  'ES6',
  ...
  'ACF NCP: Advanced Communication FunctionNetwork Control Program',
  'Acrobat',
  ...
  'Adware',
  'AE: Action Evolution',
  'AFC: Advanced Communication Function',
  'AFK Gaming',
  'After Dark',
  'Agent Software',
  ...
  'AR Mid-Tier: Action Request Mid-Tier',
  'AR System Administrator',
  'AR System Import',
  'AR System: Action Request System',
  'Architecture',
  'Ardour',
  ...
  'Boost Library',
  'Bootstrapping',
  'Bot: RoBOTic Computer Ccontrolled Entity',
  'Bottom-up Design',
  ...
  'CAR: Computer-Assisted Reviewing',
  'Careware',
  ...
  'Compiler-Compiler',
  'Componetware: Component Software',
  ...
  'DBMS: Database Management Ssystem',
  'Dbx Debugger',
  ...
  'Ghost: General Hardware-Oriented Software Transfer',
  ...
  'KDEAP: KDE Accessibility Project',
  ...
  'LAMIP: Linux Audio Multiple Interface Player',
  ...
  'MCDBA:Â  Microsoft Certified Database Administrator',
  ...
  'MicroBSD',
  'Microcode',
  'Microinstruction: Micro code Instruction',
  'Microkernel',
  'Micro-programming',
  'Microsoft .Net',
  ...
  'Mozbot',
  'Mozilla',
  'Mozilla Application Object Model (AOM)',
  'Mozilla Firefox',
  ...
  'ODNT: Object Desktop Network',
  'O.K.I.: Open Knowledge Initiative',
  'OLAP: Online Analytical Processing',
  'OLE: Object Linking and Embedding',
  'OLTP: Online Transaction Processing (OLTP)',
  'OMG: Object Management Group',
  'OmniPage Professional',
  'OO Language: Object-Oriented Language',
  ...
  'ROBODoc',
  'Robustness',
  'ROFUG: Romanian FreeBSD Users Group',
  'RosAsm',
  'Rosegarden',
  'Routine',
  'Rpcdump',
  ...
  'Sandbox',
  'Sandwich Test',
  'SAPI: Scheduling Application Programming Interface',
  ...
  'Script',
  'Scripting Languages',
  'SDD: Software Description Database',
  ...
  'Ultrix',
  'UML tool: Unified Modeling Language tool',
  ...
  'Video Game',
  'Viewer Program',
  'VirtualGL: Virtual Graphics Library',
  'Visual C++',
  'VisualKore',
